...
export const storeGet = async <T = unknown>(args: StoreGetArgs): Promise<T | undefined> =>
...
export const gitReset = async (args: GitResetArgs): Promise<void> =>
  safeInvoke<void>((bridge) => bridge.gitReset(args), undefined);

export const gitRevert = async (args: GitRevertArgs): Promise<void> =>
  safeInvoke<void>((bridge) => bridge.gitRevert(args), undefined);
...
export const gitCheckout = async (args: GitCheckoutArgs): Promise<void> =>
  safeInvoke<void>((bridge) => bridge.gitCheckout(args), undefined);
...
export const gitCurrentBranch = async (
  ...
  safeInvoke<string | null>(
    (bridge) => bridge.gitCurrentBranch(args),
    null
  );
