...
| 13 — Доработки roadmap-6 | 5 | 0 | 5 (TASK-300..304) |
| **Итого** | **78** | **66** | **12** |
...
| ID | Тема | Статус |
|---|---|---|
| TASK-300 | WorkspaceTile: убрать артефакт "—" рядом со счётчиком репозиториев | ⏳ pending |
| TASK-301 | WorkspaceHero: persist-store + shimmer-skeleton для счётчиков | ⏳ pending |
| TASK-302 | Перенести path + счётчики воркспейса в шапку (рядом с селектором) | ⏳ pending |
| TASK-303 | Drawer: убрать белый бордер у боковой панели настроек воркспейса | ⏳ pending |
| TASK-304 | Переделать граф коммитов на нормальное дерево (ветки/теги/сообщения) | ⏳ pending |
