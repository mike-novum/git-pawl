...
export type GitResetArgs = { repoPath: string; mode: 'soft' | 'mixed' | 'hard'; ref?: string };
export type GitRevertArgs = { repoPath: string; commit: string; noEdit?: boolean };
export type GitAmendArgs = { repoPath: string; message?: string; noVerify?: boolean };
export type GitCheckoutArgs = { repoPath: string; ref: string; create?: boolean };
export type GitBranchArgs = { repoPath: string; action: 'list' | 'create' | 'delete'; name?: string; force?: boolean };
export type CurrentBranchArgs = { repoPath: string };
...
export type ApiSchema = {
  ...
  gitReset: (args: GitResetArgs) => Promise<void>;
  gitRevert: (args: GitRevertArgs) => Promise<void>;
  gitAmend: (args: GitAmendArgs) => Promise<unknown>;
  gitCheckout: (args: GitCheckoutArgs) => Promise<void>;
  gitBranch: (args: GitBranchArgs) => Promise<unknown>;
  gitCurrentBranch: (args: CurrentBranchArgs) => Promise<string | null>;
...
const api: ApiSchema = {
  ...
  gitReset: (args) => invoke('git:reset', args) as Promise<void>,
  gitRevert: (args) => invoke('git:revert', args) as Promise<void>,
  gitAmend: (args) => invoke('git:amend', args),
  gitCheckout: (args) => invoke('git:checkout', args) as Promise<void>,
  gitBranch: (args) => invoke('git:branch', args),
  gitCurrentBranch: (args) =>
    invoke('git:current-branch', args) as Promise<string | null>,
