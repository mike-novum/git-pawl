...
export type GitBranchFirstParentArgs = { repoPath: string };
...
export type ApiSchema = {
  ...
  gitBranchFirstParent: (args: GitBranchFirstParentArgs) => Promise<unknown>;
...
const api: ApiSchema = {
  ...
  gitBranchFirstParent: (args) => invoke('git:branch-first-parent', args),
